...
treat **`docs_update/3-sept-2026-part-2/09-phase4b-unblock.md`** (implemented in
`docs/09-phase-4b-blocking.md` and tracked by `docs/04-task-breakdown.md`) as the source of truth. The Go side and the Hermes
