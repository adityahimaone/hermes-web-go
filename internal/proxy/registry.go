...
var NativeMethods = map[string]map[string]bool{
	...
	"/api/file/rename":                      {http.MethodPost: true},
	"/api/file/move":                        {http.MethodPost: true},
	"/api/file/create-dir":                  {http.MethodPost: true},
	"/api/file/path":                        {http.MethodPost: true},
	"/api/file/reveal":                      {http.MethodPost: true},
	"/api/file/open-vscode":                 {http.MethodPost: true},
	"/api/file/office-save":                 {http.MethodPost: true},
	"/api/folder/download":                  {http.MethodGet: true},
	...
	"/api/memory":                           {http.MethodGet: true},
	"/api/skills":                           {http.MethodGet: true},
	"/api/skills/content":                   {http.MethodGet: true},
	"/api/skills/usage":                     {http.MethodGet: true},
	"/api/chat":                             {http.MethodPost: true},
	"/api/chat/start":                       {http.MethodPost: true},
	"/api/chat/stream":                      {http.MethodGet: true},
	"/api/chat/stream/status":               {http.MethodGet: true},
	"/api/share/revoke":                     {http.MethodPost: true},
	...
	"/api/system/health":                    {http.MethodGet: true},
	"/api/session/branch":                   {http.MethodPost: true},
	"/api/session/compress/start":           {http.MethodPost: true},
	"/api/admin/reload":                     {http.MethodPost: true},
	"/api/shutdown":                         {http.MethodPost: true},
	"/api/upload/extract":                   {http.MethodPost: true},
	"/api/mcp/servers":                      {http.MethodGet: true},
	"/api/mcp/tools":                        {http.MethodGet: true},
	"/api/session/undo":                     {http.MethodPost: true},
	"/api/session/retry":                    {http.MethodPost: true},
	"/api/session/title/regenerate":         {http.MethodPost: true},
	"/api/session/yolo":                     {http.MethodPost: true},
	"/api/session/yolo/status":              {http.MethodGet: true},
	"/api/rollback/list":                    {http.MethodGet: true},
	"/api/rollback/diff":                    {http.MethodGet: true},
	"/api/rollback/restore":                 {http.MethodPost: true},
	"/api/personality/set":                  {http.MethodPost: true},
	"/api/projects/create":                  {http.MethodPost: true},
	"/api/projects/rename":                  {http.MethodPost: true},
	"/api/projects/delete":                  {http.MethodPost: true},
	"/api/extensions/status":                {http.MethodGet: true},
	"/api/extensions/registry":              {http.MethodGet: true},
	"/api/extensions/toggle":                {http.MethodPost: true},
	"/api/extensions/install":               {http.MethodPost: true},
	"/api/extensions/uninstall":             {http.MethodPost: true},
	"/api/extensions/sidecar-proxy-consent": {http.MethodPost: true},
	"/api/onboarding/complete":              {http.MethodPost: true},
	"/api/onboarding/oauth/poll":            {http.MethodGet: true},
	...
	"/api/sessions/events":                  {http.MethodGet: true},
	"/api/sessions/gateway/stream":          {http.MethodGet: true},
	"/api/escape/authorize":                 {http.MethodPost: true},
	"/api/terminal/start":                   {http.MethodPost: true},
	"/api/terminal/input":                   {http.MethodPost: true},
	"/api/terminal/resize":                  {http.MethodPost: true},
	"/api/terminal/close":                   {http.MethodPost: true},
	"/api/terminal/output":                  {http.MethodGet: true},
	"/api/bg-task-complete-ack":             {http.MethodPost: true},
	"/api/process-complete-ack":             {http.MethodPost: true},
	"/api/updates/clear_lock":               {http.MethodPost: true},
	"/api/session/lineage/report":           {http.MethodGet: true},
	"/api/session/recovery/audit":           {http.MethodGet: true},
	"/api/session/recovery/repair-safe":     {http.MethodPost: true},
	"/api/session/handoff-summary":          {http.MethodPost: true},
	"/api/session/worktree/status":          {http.MethodGet: true},
	"/api/session/worktree/remove":          {http.MethodPost: true},
	"/api/session/import":                   {http.MethodPost: true},
	"/api/session/import_cli":               {http.MethodPost: true},
	"/api/escape/list":                      {http.MethodGet: true},
	"/api/escape/file/read":                 {http.MethodGet: true},
	"/api/escape/file/raw":                  {http.MethodGet: true},
	"/api/gateway/status":                   {http.MethodGet: true},
	"/api/gateway/start":                    {http.MethodGet: true},
	"/api/gateway/stop":                     {http.MethodPost: true},
	"/api/gateway/restart":                  {http.MethodPost: true},
	"/api/workspace/upload":                 {http.MethodPost: true},
	"/api/chat/cancel":                      {http.MethodPost: true},
	"/api/updates/apply":                    {http.MethodPost: true},
...
var NativeRoutes = map[string]bool{
	...
	"/api/file/rename":                   true,
	"/api/file/move":                     true,
	"/api/file/create-dir":               true,
	"/api/file/path":                     true,
	"/api/file/reveal":                   true,
	"/api/file/open-vscode":              true,
	"/api/file/office-save":              true,
	"/api/folder/download":               true,
	"/api/upload":                        true,
	...
	"/api/skills/usage":                  true,
	"/api/chat":                          true,
	"/api/chat/start":                    true,
	"/api/chat/stream":                   true,
	"/api/chat/stream/status":            true,
	"/api/share/revoke":                  true,
	"/api/crons":                         true,
	...
	"/api/session/branch":                true,
	"/api/session/compress/start":        true,
	"/api/admin/reload":                  true,
	"/api/shutdown":                      true,
	"/api/upload/extract":                true,
	"/api/mcp/servers":                   true,
	"/api/mcp/tools":                     true,
	"/api/session/undo":                  true,
	"/api/session/retry":                 true,
	"/api/session/title/regenerate":      true,
	"/api/session/yolo":                  true,
	"/api/session/yolo/status":           true,
	"/api/rollback/list":                 true,
	"/api/rollback/diff":                 true,
	"/api/rollback/restore":              true,
	"/api/personality/set":               true,
	"/api/projects/create":               true,
	"/api/projects/rename":               true,
	"/api/projects/delete":               true,
	"/api/extensions/status":             true,
	"/api/extensions/registry":           true,
	"/api/extensions/toggle":             true,
	"/api/onboarding/complete":           true,
	"/api/session/anchor-scene":          true,
	"/api/workspaces/reorder":            true,
	"/api/updates/force":                 true,
	"/api/sessions/events":               true,
	"/api/sessions/gateway/stream":       true,
	"/api/escape/authorize":              true,
	"/api/terminal/start":                true,
	"/api/terminal/input":                true,
	"/api/terminal/resize":               true,
	"/api/terminal/close":                true,
	"/api/terminal/output":               true,
	"/api/bg-task-complete-ack":          true,
	"/api/process-complete-ack":          true,
	"/api/updates/clear_lock":            true,
	"/api/session/lineage/report":        true,
	"/api/session/recovery/audit":        true,
	"/api/session/recovery/repair-safe":  true,
	"/api/session/handoff-summary":       true,
	"/api/session/worktree/status":       true,
	"/api/session/worktree/remove":       true,
	"/api/session/import":                true,
	"/api/session/import_cli":            true,
	"/api/escape/list":                   true,
	"/api/escape/file/read":              true,
	"/api/escape/file/raw":               true,
	"/api/gateway/status":                true,
	"/api/gateway/start":                 true,
	"/api/gateway/stop":                  true,
	"/api/gateway/restart":               true,
	"/api/workspace/upload":              true,
	"/api/chat/cancel":                   true,
	"/api/updates/apply":                 true,
