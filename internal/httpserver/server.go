...
func NewRouterWithAgent(staticDir string, proxyHandler http.Handler, db *sql.DB, dataRoot string, client agentclient.AgentClient, st *approval.Store, opts ...RouterOption) http.Handler {
	...
	Wave11Router(r, routerHermesHome(o))
	Wave12Router(r, db, routerHermesHome(o))
	Wave13Router(r, db, routerHermesHome(o))
	Wave14Router(r, db, routerHermesHome(o))
	Wave16Router(r, o.auth)
	Wave17Router(r, dataRoot, routerHermesHome(o))
	Wave18Router(r, dataRoot, routerHermesHome(o))
	Wave19Router(r, db, routerHermesHome(o))
	Wave20Router(r, db, dataRoot)
